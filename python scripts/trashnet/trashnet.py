...
import glob
shuffle_data = True
hdf5_path = '/home/haider/scripts-test-area/trash-hdf5'
...
hdf5_file.create_dataset("train", train_shape, np.int8)
hdf5_file.create_dataset("val", val_shape, np.int8)
hdf5_file.create_dataset("test", test_shape, np.int8)
