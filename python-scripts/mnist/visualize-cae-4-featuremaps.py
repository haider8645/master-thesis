...
model_def = '/home/haider/Desktop/output comparison/from 10-03-2018/conv-4-deconv-4/architecture-7/with-elu/train-4-conv4-smaller.prototxt'
model_weights = '/home/haider/Desktop/output comparison/from 10-03-2018/conv-4-deconv-4/architecture-7/with-elu/_iter_300000.caffemodel'
...
a = np.arange(256,dtype=float).reshape(4, 64)
b = np.arange(192000,dtype=float).reshape(750, 256)
...
for j in range(0,750):
    ...
    if j < 750:
        b[j] = np.concatenate((a[0,:],a[1,:],a[2,:],a[3,:]),axis=0)
        print b[j]
...
Y = tsne.tsne(b, no_dims= 2, initial_dims=256, perplexity=30.0)
